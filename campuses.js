...
window.CAMPUS_DIRECTORY = {
  rutgers_nb: {
    ...
    resources: [
      {
        tags: ["mental_health", "lonely", "anxious", "depressed", "stress", "burnout", "crisis"],
      ...
      },
      {
        ...
        links: [{ label: "Learning Centers Website", url: "https://learningcenters.rutgers.edu/" }]
      },
      {
        ...
        links: [{ label: "Scarlet Hub", url: "https://scarlethub.rutgers.edu/" }]
      }
    ]
  },
